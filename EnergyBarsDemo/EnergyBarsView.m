...
@interface EnergyBarsView ()

@property(nonatomic, strong) EnergyProgressView* progressView;
...
- (EnergyProgressView*)progressView {
    if (_progressView == nil) {
        _progressView = [[EnergyProgressView alloc] init];
    }
